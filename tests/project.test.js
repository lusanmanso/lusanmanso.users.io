...
describe('Project API Tests', () => {
  ...
  describe('GET /api/project/:id', () => {
    ...
    it('should fail with archived project', async () => {
  ...
  describe('PUT /api/project/:id', () => {
    ...
    it('should update project client successfully', async () => {
      ...
      if (res.status === 200) {
        expect(res.body.project.client._id).toBe(newClient._id.toString());
      }
    });
    ...
    it('should fail with duplicate name for same client', async () => {
      // Create another project with same client
      await new Project({
  ...
  describe('PATCH /api/project/archive/:id', () => {
    ...
    it('should archive project successfully', async () => {
      ...
      if (res.status === 200) {
        ...
        const archivedProject = await Project.findById(testProject._id);
  ...
  describe('PATCH /api/project/recover/:id', () => {
    ...
    it('should fail with non-archived project', async () => {
      testProject.archived = false;
      await testProject.save();
