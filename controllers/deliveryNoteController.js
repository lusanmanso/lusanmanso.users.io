...
const PDFDocument = require('pdfkit'); // Required for PDF generation [cite: 6]
...
if (pinataApiKey && pinataSecretApiKey) {
    ...
    console.warn("PINATA API Keys not configured. IPFS operations will fail.");
    // Fallback or error handling if IPFS is mandatory
}
